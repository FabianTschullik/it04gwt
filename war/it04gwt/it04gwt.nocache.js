...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "it04gwt" because\n';
  ...
  $wnd.__gwt_activeModules['it04gwt'] = {
    'moduleName' : 'it04gwt',
    'bindings' : function() {
      return {};
    }
 ...
 * "/it04gwt.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['it04gwt'].superdevmode = true;

  var expectedSuffix = '/it04gwt.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + it04gwt + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:it04gwt';
  var devModeSessionKey = '__gwtDevModeSession:it04gwt';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/it04gwt/it04gwt.nocache.js';
  ...
  $wnd.__gwt_activeModules['it04gwt'].canRedirect = true;
  $wnd.__gwt_activeModules['it04gwt'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/it04gwt?user.agent=' + ua + '&_callback=' + callback;
