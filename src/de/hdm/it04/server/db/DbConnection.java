...
public class DbConnection {
     ...
     * Diese Methode bietet einen globen Zugriff auf das Objekt über die instanzoperation.
     * 
    ...
    public static Connection connection() {
        ...
        if (con == null) {
            ...
            try {
                    ...
                    Class.forName("com.mysql.jdbc.Driver");  //f�r local use: "com.mysql.jdbc.Driver" or "com.mysql.jdbc.GoogleDriver" for cloud sql
                    url = localUrl;
