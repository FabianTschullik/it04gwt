...
public class EnderzeugnisGUI {
	...
	// ----------------------------------------------------------------------------
	/**
	 * Hier k�nnen Name, Beschreibung und Preis eines Enderzeugnisses ver�ndert
	 ...
	 *            Vektor
	 * @return vPanel welches die Tabelle enth�lt
	 */
	...
	/**
	 * Tree zeigt das Enderzeugnis mit seiner zusammengeh�rigen Baugruppe
	 * 
	 * @param baugruppe
