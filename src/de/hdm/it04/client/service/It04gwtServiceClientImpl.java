...
/*-------------------------------------------------------------------------------------------*/
	...
	private class DeleteBauteilCallback implements AsyncCallback {
		...
		@Override
		public void onFailure(Throwable caught) {
			alertgui.load("Bauteil konnte nicht gel�scht werden", "red");
		}
...
/*-------------------------------------------------------------------------------------------*/	
	...
	private class DeleteBaugruppeCallback implements AsyncCallback{
		...
		@Override
		public void onFailure(Throwable caught) {
			alertgui.load("Baugruppe konnte nicht gel�scht werden", "red");
		}

		@Override
		public void onSuccess(Object result) {
			if (result instanceof String){
				alertgui.load("Bautgruppe wurde erfolgreich gel�scht", "green");
		}
		else {
			//maingui.showError();
		}			
