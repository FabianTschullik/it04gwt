...
public class BearbeitenBauteilMain extends Composite {
	
	private VerticalPanel vPanel = new VerticalPanel();
	private MainViewEditor main;
	
	public BearbeitenBauteilMain() {

		initWidget(this.vPanel);
		this.main = main;

		Label label1 = new Label("Bearbeiten Sie das Bauteil:");
	...
	public void openSpeichernBauteilMain() {
		vPanel.clear();
		SpeichernBauteilMain SpeichernBauteilMain = new SpeichernBauteilMain();
		vPanel.add(SpeichernBauteilMain);
	}
